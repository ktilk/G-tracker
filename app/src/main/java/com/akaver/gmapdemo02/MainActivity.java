...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        if (locationPrevious != null){
            speedCurrent = calculateSpeed(timePrevious, timeCurrent, locationPrevious, location);
    ...
    public double calculateSpeed(long prevTime, long curTime, Location prevLoc, Location curLoc){
        long time = curTime - prevTime;
        double dist = prevLoc.distanceTo(curLoc);
        return dist/time;
    }

/*    public String convertSpeedToMinKM(double speed){
        double minKM = (50/3)/speed;
        double minutes = (minKM % 3600)/60;
        double seconds = minKM % 60;
